...
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_5 (+ I0_19 0))(= T_c (str.++ T0_19 T1_19))(= I0_19 (str.len T4_19))(= 0 (str.len T0_19))(= T1_19 (str.++ T2_19 T3_19))(= T2_19 (str.++ T4_19 T5_19))(= T5_19 "=")(not (str.in.re T4_19 (str.to.re "=")))) 
	(and (= PCTEMP_LHS_5 (- 1))(= T_c (str.++ T0_19 T1_19))(= 0 (str.len T0_19))(not (str.in.re T1_19 (str.to.re "="))))))
