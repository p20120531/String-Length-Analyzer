...
(assert (ite T_SELECT_1 
	(and (= PCTEMP_LHS_1 (+ I0_2 0))(= var_0xINPUT_8 (str.++ T0_2 T1_2))(= I0_2 (str.len T4_2))(= 0 (str.len T0_2))(= T1_2 (str.++ T2_2 T3_2))(= T2_2 (str.++ T4_2 T5_2))(= T5_2 "=")(not (str.in.re T4_2 (str.to.re "=")))) 
	(and (= PCTEMP_LHS_1 (- 1))(= var_0xINPUT_8 (str.++ T0_2 T1_2))(= 0 (str.len T0_2))(not (str.in.re T1_2 (str.to.re "="))))))
...
(assert (ite T_SELECT_2 
	(and (= PCTEMP_LHS_3 (+ I0_7 0))(= PCTEMP_LHS_2 (str.++ T0_7 T1_7))(= I0_7 (str.len T4_7))(= 0 (str.len T0_7))(= T1_7 (str.++ T2_7 T3_7))(= T2_7 (str.++ T4_7 T5_7))(= T5_7 "X")(not (str.in.re T4_7 (str.to.re "X")))) 
	(and (= PCTEMP_LHS_3 (- 1))(= PCTEMP_LHS_2 (str.++ T0_7 T1_7))(= 0 (str.len T0_7))(not (str.in.re T1_7 (str.to.re "X"))))))
