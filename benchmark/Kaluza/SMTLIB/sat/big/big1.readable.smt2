...
(assert (ite T_SELECT_1 
	(and (= PCTEMP_LHS_1 (+ I0_2 0))(= var_0xINPUT_130 (str.++ T0_2 T1_2))(= I0_2 (str.len T4_2))(= 0 (str.len T0_2))(= T1_2 (str.++ T2_2 T3_2))(= T2_2 (str.++ T4_2 T5_2))(= T5_2 "?")(not (str.in.re T4_2 (str.to.re "?")))) 
	(and (= PCTEMP_LHS_1 (- 1))(= var_0xINPUT_130 (str.++ T0_2 T1_2))(= 0 (str.len T0_2))(not (str.in.re T1_2 (str.to.re "?"))))))
(assert (= T_SELECT_2 (not (= PCTEMP_LHS_2 (- 1)))))
(assert (ite T_SELECT_2 
	(and (= PCTEMP_LHS_2 (+ I0_4 0))(= var_0xINPUT_130 (str.++ T0_4 T1_4))(= I0_4 (str.len T4_4))(= 0 (str.len T0_4))(= T1_4 (str.++ T2_4 T3_4))(= T2_4 (str.++ T4_4 T5_4))(= T5_4 "#")(not (str.in.re T4_4 (str.to.re "#")))) 
	(and (= PCTEMP_LHS_2 (- 1))(= var_0xINPUT_130 (str.++ T0_4 T1_4))(= 0 (str.len T0_4))(not (str.in.re T1_4 (str.to.re "#"))))))
...
(assert PCTEMP_LHS_4)
(assert (ite PCTEMP_LHS_4 
	(= T_7 PCTEMP_LHS_4_idx_0) 
         true))
(assert (= T_SELECT_3 (not (= PCTEMP_LHS_5 (- 1)))))
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_5 (+ I0_13 0))(= T_7 (str.++ T0_13 T1_13))(= I0_13 (str.len T4_13))(= 0 (str.len T0_13))(= T1_13 (str.++ T2_13 T3_13))(= T2_13 (str.++ T4_13 T5_13))(= T5_13 "=")(not (str.in.re T4_13 (str.to.re "=")))) 
	(and (= PCTEMP_LHS_5 (- 1))(= T_7 (str.++ T0_13 T1_13))(= 0 (str.len T0_13))(not (str.in.re T1_13 (str.to.re "="))))))
(assert (= T_9 (= PCTEMP_LHS_5 (- 1))))
(assert (= T_a (not T_9)))
(assert T_a)
(assert PCTEMP_LHS_4)
(assert (ite PCTEMP_LHS_4 
	(= T_b PCTEMP_LHS_4_idx_1) 
         true))
(assert (= T_SELECT_4 (not (= PCTEMP_LHS_6 (- 1)))))
(assert (ite T_SELECT_4 
	(and (= PCTEMP_LHS_6 (+ I0_18 0))(= T_b (str.++ T0_18 T1_18))(= I0_18 (str.len T4_18))(= 0 (str.len T0_18))(= T1_18 (str.++ T2_18 T3_18))(= T2_18 (str.++ T4_18 T5_18))(= T5_18 "=")(not (str.in.re T4_18 (str.to.re "=")))) 
	(and (= PCTEMP_LHS_6 (- 1))(= T_b (str.++ T0_18 T1_18))(= 0 (str.len T0_18))(not (str.in.re T1_18 (str.to.re "="))))))
(assert (= T_d (= PCTEMP_LHS_6 (- 1))))
(assert (= T_e (not T_d)))
(assert T_e)
(assert PCTEMP_LHS_4)
(assert (ite PCTEMP_LHS_4 
	(= T_f PCTEMP_LHS_4_idx_2) 
         true))
(assert (= T_SELECT_5 (not (= PCTEMP_LHS_7 (- 1)))))
(assert (ite T_SELECT_5 
	(and (= PCTEMP_LHS_7 (+ I0_23 0))(= T_f (str.++ T0_23 T1_23))(= I0_23 (str.len T4_23))(= 0 (str.len T0_23))(= T1_23 (str.++ T2_23 T3_23))(= T2_23 (str.++ T4_23 T5_23))(= T5_23 "=")(not (str.in.re T4_23 (str.to.re "=")))) 
	(and (= PCTEMP_LHS_7 (- 1))(= T_f (str.++ T0_23 T1_23))(= 0 (str.len T0_23))(not (str.in.re T1_23 (str.to.re "="))))))
