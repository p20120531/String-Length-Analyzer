...
(assert (ite T_SELECT_2 
	...
	(and (= PCTEMP_LHS_2 (- 1))(= var_0xINPUT_36574 (str.++ T0_10 T1_10))(= 0 (str.len T0_10))(not (str.in.re T1_10 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "a") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re ".")))))))
(assert (= T_9 (< (- 1) PCTEMP_LHS_2)))
(assert T_9)
(assert (= T_SELECT_3 (not (= PCTEMP_LHS_3 (- 1)))))
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_3 (+ I0_13 PCTEMP_LHS_2))(= var_0xINPUT_36574 (str.++ T0_13 T1_13))(= I0_13 (str.len T4_13))(= PCTEMP_LHS_2 (str.len T0_13))(= T1_13 (str.++ T2_13 T3_13))(= T2_13 (str.++ T4_13 T5_13))(= T5_13 ";")(not (str.in.re T4_13 (str.to.re ";")))) 
	(and (= PCTEMP_LHS_3 (- 1))(= var_0xINPUT_36574 (str.++ T0_13 T1_13))(= PCTEMP_LHS_2 (str.len T0_13))(not (str.in.re T1_13 (str.to.re ";"))))))
