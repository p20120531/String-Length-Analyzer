...
(assert (not (str.in.re PCTEMP_LHS_1_idx_0 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "a") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re ".")))))
...
(assert (ite T_SELECT_1 
	(and (= PCTEMP_LHS_5 (+ I0_24 0))(= T_c (str.++ T0_24 T1_24))(= I0_24 (str.len T4_24))(= 0 (str.len T0_24))(= T1_24 (str.++ T2_24 T3_24))(= T2_24 (str.++ T4_24 T5_24))(= T5_24 "__utmz=218069774.")(not (str.in.re T4_24 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "z") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re "."))))) 
	(and (= PCTEMP_LHS_5 (- 1))(= T_c (str.++ T0_24 T1_24))(= 0 (str.len T0_24))(not (str.in.re T1_24 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "z") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re ".")))))))
...
(assert (ite T_SELECT_2 
	(and (= PCTEMP_LHS_6 (+ I0_68 0))(= T_25 (str.++ T0_68 T1_68))(= I0_68 (str.len T4_68))(= 0 (str.len T0_68))(= T1_68 (str.++ T2_68 T3_68))(= T2_68 (str.++ T4_68 T5_68))(= T5_68 "__utma=218069774.")(not (str.in.re T4_68 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "a") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re "."))))) 
	(and (= PCTEMP_LHS_6 (- 1))(= T_25 (str.++ T0_68 T1_68))(= 0 (str.len T0_68))(not (str.in.re T1_68 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "a") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re ".")))))))
...
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_7 (+ I0_83 PCTEMP_LHS_6))(= T_2d (str.++ T0_83 T1_83))(= I0_83 (str.len T4_83))(= PCTEMP_LHS_6 (str.len T0_83))(= T1_83 (str.++ T2_83 T3_83))(= T2_83 (str.++ T4_83 T5_83))(= T5_83 ";")(not (str.in.re T4_83 (str.to.re ";")))) 
	(and (= PCTEMP_LHS_7 (- 1))(= T_2d (str.++ T0_83 T1_83))(= PCTEMP_LHS_6 (str.len T0_83))(not (str.in.re T1_83 (str.to.re ";"))))))
