...
(assert (ite T_SELECT_2 
	...
	(and (= PCTEMP_LHS_2 (- 1))(= var_0xINPUT_16091 (str.++ T0_9 T1_9))(= 0 (str.len T0_9))(not (str.in.re T1_9 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "z") (str.to.re "=") (str.to.re "1") (str.to.re "6") (str.to.re "9") (str.to.re "4") (str.to.re "1") (str.to.re "3") (str.to.re "1") (str.to.re "6") (str.to.re "9") (str.to.re ".")))))))
(assert (= T_8 (< (- 1) PCTEMP_LHS_2)))
(assert T_8)
(assert (= T_SELECT_3 (not (= PCTEMP_LHS_3 (- 1)))))
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_3 (+ I0_12 PCTEMP_LHS_2))(= var_0xINPUT_16091 (str.++ T0_12 T1_12))(= I0_12 (str.len T4_12))(= PCTEMP_LHS_2 (str.len T0_12))(= T1_12 (str.++ T2_12 T3_12))(= T2_12 (str.++ T4_12 T5_12))(= T5_12 ";")(not (str.in.re T4_12 (str.to.re ";")))) 
	(and (= PCTEMP_LHS_3 (- 1))(= var_0xINPUT_16091 (str.++ T0_12 T1_12))(= PCTEMP_LHS_2 (str.len T0_12))(not (str.in.re T1_12 (str.to.re ";"))))))
