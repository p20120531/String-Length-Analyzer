...
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_3 (+ I0_40 0))(= T_1b (str.++ T0_40 T1_40))(= I0_40 (str.len T4_40))(= 0 (str.len T0_40))(= T1_40 (str.++ T2_40 T3_40))(= T2_40 (str.++ T4_40 T5_40))(= T5_40 "gclid=")(not (str.in.re T4_40 (re.++ (str.to.re "g") (str.to.re "c") (str.to.re "l") (str.to.re "i") (str.to.re "d") (str.to.re "="))))) 
	(and (= PCTEMP_LHS_3 (- 1))(= T_1b (str.++ T0_40 T1_40))(= 0 (str.len T0_40))(not (str.in.re T1_40 (re.++ (str.to.re "g") (str.to.re "c") (str.to.re "l") (str.to.re "i") (str.to.re "d") (str.to.re "=")))))))
