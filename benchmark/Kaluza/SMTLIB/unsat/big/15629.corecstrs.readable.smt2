...
(assert (ite T_SELECT_1 
	(and (= PCTEMP_LHS_1 (+ I0_5 0))(= var_0xINPUT_49455 (str.++ T0_5 T1_5))(= I0_5 (str.len T4_5))(= 0 (str.len T0_5))(= T1_5 (str.++ T2_5 T3_5))(= T2_5 (str.++ T4_5 T5_5))(= T5_5 "__utmv=218069774.")(not (str.in.re T4_5 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "v") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re "."))))) 
	(and (= PCTEMP_LHS_1 (- 1))(= var_0xINPUT_49455 (str.++ T0_5 T1_5))(= 0 (str.len T0_5))(not (str.in.re T1_5 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "v") (str.to.re "=") (str.to.re "2") (str.to.re "1") (str.to.re "8") (str.to.re "0") (str.to.re "6") (str.to.re "9") (str.to.re "7") (str.to.re "7") (str.to.re "4") (str.to.re ".")))))))
...
(assert (ite T_SELECT_2 
	...
	(and (= PCTEMP_LHS_2 (- 1))(= var_0xINPUT_13852 (str.++ T0_9 T1_9))(= 0 (str.len T0_9))(not (str.in.re T1_9 (re.++ (str.to.re "_") (str.to.re "_") (str.to.re "u") (str.to.re "t") (str.to.re "m") (str.to.re "z") (str.to.re "=") (str.to.re "1") (str.to.re "6") (str.to.re "9") (str.to.re "4") (str.to.re "1") (str.to.re "3") (str.to.re "1") (str.to.re "6") (str.to.re "9") (str.to.re ".")))))))
(assert (= T_8 (< (- 1) PCTEMP_LHS_2)))
(assert T_8)
(assert (= T_SELECT_3 (not (= PCTEMP_LHS_3 (- 1)))))
(assert (ite T_SELECT_3 
	(and (= PCTEMP_LHS_3 (+ I0_12 PCTEMP_LHS_2))(= var_0xINPUT_13852 (str.++ T0_12 T1_12))(= I0_12 (str.len T4_12))(= PCTEMP_LHS_2 (str.len T0_12))(= T1_12 (str.++ T2_12 T3_12))(= T2_12 (str.++ T4_12 T5_12))(= T5_12 ";")(not (str.in.re T4_12 (str.to.re ";")))) 
	(and (= PCTEMP_LHS_3 (- 1))(= var_0xINPUT_13852 (str.++ T0_12 T1_12))(= PCTEMP_LHS_2 (str.len T0_12))(not (str.in.re T1_12 (str.to.re ";"))))))
