...
class VmtNode{
    ...
    public:
        VmtNode (const string& name,const VmtType& type=OTHER,const size_t& num=0): _name(name) {_paraList.assign(6,VmtNodeSet()); _type = type; _num = num; _source=0; _flag = 0;}
...
class AutOpMgr{
    public :
        AutOpMgr(){initXSListAndEpsilon(); _gflag = 0;}
        // Converter
